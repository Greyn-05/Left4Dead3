...
//     [SerializeField] private TMP_Text[] bindingTexts = new TMP_Text[8]; // Up, Down, Left, Right, Interact, Reload, Jump, and Composite
...
//     private void Start()
//     {
//         UpdateBindingDisplay(moveAction, 0);
//         UpdateBindingDisplay(interactAction, 4);
//         UpdateBindingDisplay(reloadAction, 5);
//         UpdateBindingDisplay(jumpAction, 6);
//     }

//     public void StartRebinding(string actionName, string bindingName)
//     {
//         InputAction actionToRebind = null;
//         int bindingTextIndex = -1;
...
//         if (actionToRebind != null && bindingTextIndex >= 0)
//         {
//             startRebindingObject.SetActive(false);
//             waitingForInputObject.SetActive(true);

//             int bindingIndex = FindBindingIndex(actionToRebind, "<Keyboard>/someKey");
...
//                     .OnComplete(operation => RebindComplete(operation, bindingTextIndex))
//                     .Start();
//             }
//         }
//     }

//     private void RebindComplete(InputActionRebindingExtensions.RebindingOperation operation, int bindingTextIndex)
//     {
...
//         bindingTexts[bindingTextIndex].text = bindingDisplayString;
//         operation.Dispose();
//     }

//     private void UpdateBindingDisplay(InputActionReference actionRef, int bindingTextIndex)
//     {
...
//         UpdateBindingText(action, bindingTextIndex, bindingIndexUp, 0);
//         UpdateBindingText(action, bindingTextIndex, bindingIndexDown, 1);
//         UpdateBindingText(action, bindingTextIndex, bindingIndexLeft, 2);
//         UpdateBindingText(action, bindingTextIndex, bindingIndexRight, 3);
//     }

//     private void UpdateBindingText(InputAction action, int bindingTextIndex, int bindingIndex, int offset)
//     {
//         if (bindingIndex >= 0)
//         {
//             bindingTexts[bindingTextIndex + offset].text = action.GetBindingDisplayString(bindingIndex);
//         }
//     }
